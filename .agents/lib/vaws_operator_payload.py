...
RESULT_MARKER = "__VAWS_OPERATOR_RESULT__"
...
def run(payload):
    ...
    stage = Path(tempfile.mkdtemp(prefix=".vaws-operator-", dir=root))
    ...
    try:
        ...
        modules = {}
        functions = {role: _load_callable(stage / entry["file"], entry["function"], "_vaws_" + role, modules)
